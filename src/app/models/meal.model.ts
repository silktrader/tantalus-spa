...
export class Meal {
  public static mealNames: ReadonlyArray<string> = ['Breakfast', 'Lunch', 'Dinner', 'Snacks'];

  public static numbers: ReadonlyArray<number> = Array.from(Meal.mealNames.keys());

  constructor(public readonly order: number, private readonly portions: Portion[]) {}
